<template>
  <header class="fixed top-0 left-0 right-0 z-50 bg-white shadow-sm">
    ...
    >
      ...
      <a href="/events" class="underline font-semibold hover:text-sky-100">
        see upcoming events
      </a>
      <button
    ...
    <div class="border-b border-gray-100">
      <div class="max-w-6xl mx-auto px-4 sm:px-6 flex items-center gap-4 h-16">
        ...
        <div class="flex items-center gap-4 ml-auto flex-shrink-0">
          ...
          <a href="/chat" class="hidden md:flex items-center gap-1.5 text-sm text-gray-600 hover:text-orange-600 transition-colors">
            <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
